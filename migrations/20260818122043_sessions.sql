...
CREATE TABLE sessions (
    ...
    -- Device info
    device_name TEXT NOT NULL, -- "Chrome on Windows", "iPhone App"
    user_agent TEXT,
    ip_address INET,
    
    -- Auth data
    data JSONB NOT NULL DEFAULT '{}', -- store roles, csrf, etc
...
-- Down
DROP TRIGGER IF EXISTS trigger_touch_last_seen ON sessions;
